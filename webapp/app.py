...
import os
from models import db, BFN, BFN_Relationship, RelationTypes, BFN_LexicalUnits, BrasilFN,  BrasilFN_LexicalUnits, DiCoEnviro, DiCoEnviro_LexicalUnits, DiCoInfo, DiCoInfo_LexicalUnits, GermanFN, GermanFN_LexicalUnits, GFOL, GFOL_LexicalUnits, SpanishFN, SpanishFN_LexicalUnits, SweFN, SweFN_LexicalUnits, MultilingualFN, MultilingualFN_LexicalUnits
